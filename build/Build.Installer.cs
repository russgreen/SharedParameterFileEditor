...
partial class Build
{
    ...
    .Executes(() =>
    {
        var aipProjectPath = Path.Combine(RootDirectory, @"Installer\SharedParameterFileEditor.aip");
        var version = Solution.SharedParameterFileEditor.GetProperty("Version");
    ...
    {
        var aipOutputPath = Path.Combine(RootDirectory, @"Installer\SharedParameterFileEditor-SetupFiles");
